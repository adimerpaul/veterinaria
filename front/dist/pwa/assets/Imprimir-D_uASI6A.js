import{c as g,Q as y}from"./numeroaletras-B5rgbfjP.js";import{i as b}from"./index-BNEQuYOD.js";import{p as $}from"./index-ByRWkf4M.js";import{h as x}from"./moment-C5S46NFB.js";class L{static factura(t){return console.log("factura",t),new Promise((c,d)=>{const o=g.conversorNumerosALetras,i=new o().convertToText(parseInt(t.total)),l={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},n=b().env;console.log(n);const a=t.nombre+" "+t.numeroFactura;y.toDataURL(a,l).then(e=>{let s=`${this.head()}
...
</html>`,document.getElementById("myElement").innerHTML=s,new $.Printd().print(document.getElementById("myElement")),c(e)}).catch(e=>{d(e)})})}static formatDate(t){return t==null||t===""?"":x(t).format("DD/MM/YYYY HH:mm A")}static nota(t,c=!0){return console.log("factura",t),new Promise((d,o)=>{const m=g.conversorNumerosALetras,l=new m().convertToText(parseInt(t.total)),n={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}};b().env,y.toDataURL(`Fecha: ${t.fecha_emision} Monto: ${parseFloat(t.total).toFixed(2)}`,n).then(a=>{let e=`${this.head()}
  <!--div style='padding-left: 0.5cm;padding-right: 0.5cm'>
...
</html>`,console.log(r),document.getElementById("myElement").innerHTML=r,new $.Printd().print(document.getElementById("myElement")),c(p)}).catch(p=>d(p))}catch(o){d(o)}})}static cotizacion(t,c,d,o,m=!0){return(o==null||o==="")&&(o=0),new Promise((i,l)=>{const n=g.conversorNumerosALetras,e=new n().convertToText(parseInt(d)),s=x().format("YYYY-MM-DD"),p={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},r=b().env;y.toDataURL(`Fecha: ${s} Monto: ${parseFloat(d).toFixed(2)}`,p).then(h=>{let v=`${this.head()}
  <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
  <img src="logo.png" alt="logo" style="width: 100px; height: 50px; display: block; margin-left: auto; margin-right: auto;">
...
</html>`,document.getElementById("myElement").innerHTML=v,m&&new $.Printd().print(document.getElementById("myElement")),i(h)}).catch(h=>{l(h)})})}static notaCompra(t){return console.log("factura",t),new Promise((c,d)=>{const o=g.conversorNumerosALetras,i=new o().convertToText(parseInt(t.total)),l={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},n=b().env;y.toDataURL(`Fecha: ${t.fecha_emision} Monto: ${parseFloat(t.total).toFixed(2)}`,l).then(async a=>{let e=`${this.head()}
  <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
  <img src="logo.png" alt="logo" style="width: 100px; height: 50px; display: block; margin-left: auto; margin-right: auto;">
...
</html>`,document.getElementById("myElement").innerHTML=e,new $.Printd().print(document.getElementById("myElement")),c(a)}).catch(a=>{d(a)})})}static reportTotal(t,c){const d=t.filter(i=>i.tipoVenta==="Ingreso").reduce((i,l)=>i+l.montoTotal,0),o=t.filter(i=>i.tipoVenta==="Egreso").reduce((i,l)=>i+l.montoTotal,0),m=d-o;return console.log("montoTotal",m),new Promise((i,l)=>{const n=g.conversorNumerosALetras,a=new n,e=Math.abs(m),s=a.convertToText(parseInt(e)),p={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},r=b().env;y.toDataURL(` Monto: ${parseFloat(m).toFixed(2)}`,p).then(h=>{let v=`${this.head()}
  <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
...
<table>
...
</html>`,document.getElementById("myElement").innerHTML=v,new $.Printd().print(document.getElementById("myElement")),i(h)}).catch(h=>{l(h)})})}static reciboCompra(t){return new Promise((c,d)=>{const o=g.conversorNumerosALetras,i=new o().convertToText(parseInt(t.total)),l={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},n=b().env;y.toDataURL(`Fecha: ${t.date} Monto: ${parseFloat(t.total).toFixed(2)}`,l).then(a=>{let e=`${this.head()}
    <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
    <img src="logo.png" alt="logo" style="width: 100px; height: 100px; display: block; margin-left: auto; margin-right: auto;">
    ...
    </html>`,document.getElementById("myElement").innerHTML=r,new $.Printd().print(document.getElementById("myElement")),m(p)}).catch(p=>{i(p)})})}static head(){return`<html>
<style>
      .titulo{
      font-size: 12px;
      text-align: center;
