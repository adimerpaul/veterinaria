import{g as L,r as u,k as h,a1 as Q,c as Y,o as f,w as r,a as s,b as t,Q as V,e as w,at as A,f as v,t as o,a7 as D,a9 as B,aa as S}from"./index-CeLS1kfd.js";import{Q as q}from"./QMarkupTable-BZbS-C9N.js";import{Q as R}from"./QPage-g5g7VCmC.js";import{h as P}from"./moment-C5S46NFB.js";import{E as T}from"./Excel-CKQ98bqC.js";import{p as I}from"./index-ByRWkf4M.js";import{_ as F}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";const O={class:"row items-end q-col-gutter-sm"},z={class:"col-12 col-md-2"},U={class:"col-12 col-md-3"},j={class:"col-12 col-md-2"},H={class:"col-6 col-md-2"},G={class:"col-6 col-md-2"},J={class:"text-subtitle1 q-mb-sm"},K={class:"text-right"},W={class:"text-right"},X={class:"text-right"},Z={class:"text-right"},tt={class:"text-right"},et={class:"bg-grey-2"},lt={class:"text-right text-bold"},at={class:"text-right text-bold"},ot={class:"text-right text-bold"},st={__name:"ReporteAlmacen",setup(dt){const{proxy:M}=L(),n=u(P().format("YYYY-MM-DD")),p=u(""),m=u(!1),g=u([]),i=u([]),b=h(()=>P(n.value).format("DD/MM/YYYY"));Q(x);function x(){m.value=!0,M.$axios.get("/reportes/almacen-dia",{params:{fecha:n.value}}).then(l=>{g.value=l.data||[],_()}).finally(()=>{m.value=!1})}function _(){const l=(p.value||"").toLowerCase();if(!l){i.value=g.value;return}i.value=g.value.filter(e=>(e.codigo||"").toLowerCase().includes(l)||(e.nombre||"").toLowerCase().includes(l))}function c(l){if(l==null)return"";const e=Number(l);return isNaN(e)?"":e.toFixed(2)}const y=h(()=>i.value.reduce((l,e)=>l+(e.comprado||0),0)),C=h(()=>i.value.reduce((l,e)=>l+(e.vendido||0),0)),k=h(()=>i.value.reduce((l,e)=>l+(Number(e.stock)||0),0));function N(){const l=[{sheet:`Almacen_${n.value}`,columns:[{label:"Código",value:"codigo"},{label:"Detalle",value:"nombre"},{label:"Presentación",value:e=>`${e.presentacion||""} ${e.contenido||""}`.trim()},{label:"PC",value:e=>c(e.pc)},{label:"PV",value:e=>c(e.pv)},{label:"Comprado",value:"comprado"},{label:"Vendido",value:"vendido"},{label:"Stock",value:"stock"}],content:i.value}];T.export(l,`Reporte_Almacen_${n.value}`)}function E(){const l=new I.Printd,e=`
    <style>
